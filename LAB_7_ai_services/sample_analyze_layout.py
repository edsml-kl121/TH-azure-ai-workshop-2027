...
def analyze_layout_from_local_file():
    ...
    local_file_path = "image.png"  # Change this to your local file path
    ...
    print(f"📄 Analyzing local file: {local_file_path}")
    
    # Read the local file
    with open(local_file_path, "rb") as file:
        file_data = file.read()
    
    # Use bytes_source for local files instead of url_source
    poller = document_intelligence_client.begin_analyze_document(
        "prebuilt-layout", AnalyzeDocumentRequest(bytes_source=file_data)
    )
...
if __name__ == "__main__":
    ...
    try:
        ...
        analyze_layout_from_local_file()
