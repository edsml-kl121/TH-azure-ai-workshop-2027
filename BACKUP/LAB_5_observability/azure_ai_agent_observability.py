...
async def main():
    async with (
        ...
        # Disable live_metrics to avoid freezing if Application Insights is not properly configured
        # await client.configure_azure_monitor(enable_live_metrics=False)
