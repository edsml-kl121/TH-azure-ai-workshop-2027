...
PROJECT_MI_FOUNDARY_ROLE = "Foundry User"
PROJECT_MI_LOGS_ROLE = "Log Analytics Data Reader"
...
def print_eval_auth_guidance(error: AuthenticationError) -> None:
    """Print targeted guidance for Foundry evaluation authorization failures."""
    print()
    print("Evaluation authorization failed.")
    print(str(error))
    print()
    print("Foundry evaluations run through the project managed identity, not just your signed-in user.")
    print("Verify these role assignments for the project managed identity:")
    print(f"- {PROJECT_MI_FOUNDARY_ROLE} on the Foundry account scope")
    print(f"- {PROJECT_MI_FOUNDARY_ROLE} on the Foundry project scope")
    print(f"- {PROJECT_MI_LOGS_ROLE} on the linked Log Analytics workspace")
    print("If you just added the roles, wait a few minutes for Azure RBAC propagation and run the sample again.")
...
async def main() -> None:
    try:
        ...
        print_eval_auth_guidance(error)
